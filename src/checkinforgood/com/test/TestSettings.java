...
public class TestSettings extends ActivityInstrumentationTestCase2<CheckinNativeActivity> {
	private Solo solo;
	...
	public void testSharingSettings() {
		...
		solo.clickOnButton("Clear FB");
		assertTrue("Clear FB clicked",true);
		solo.clickOnButton("Clear TW");
		assertTrue("Clear TW clicked",true);
		solo.sleep(2000);
	}	
}
